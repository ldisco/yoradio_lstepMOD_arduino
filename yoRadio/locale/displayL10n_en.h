...
const char              prv[]    PROGMEM = ", gust ";
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, temp.: %+.1f\260C (feels like %+.0f\260C) \007 press.: %d mm \007 hum.: %d%% \007 wind %s %.1f%s m/s (st. %s)";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\260C \007 pressure: %d mm \007 humidity: %d%%";
#endif
