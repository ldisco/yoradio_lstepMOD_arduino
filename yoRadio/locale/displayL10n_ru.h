...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, темп.: %+.1f\260C (ощущ.как %+.0f\260C) \007 давл.: %d мм \007 влаж.: %d%% \007 ветер %s %.1f%s м/с (м.ст. %s)";
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\260C \007 давление: %d mm \007 влажность: %d%%";
#endif
