...
#include "AsyncTCP.h"
  ...
  #define WS_MAX_QUEUED_MESSAGES 32 // [FIX] Снижено с 128 до 32 — меньше памяти на клиента при медленном соединении
#endif
#else
...
#ifdef ESP32
#define DEFAULT_MAX_WS_CLIENTS 4 // [FIX] Снижено с 8 до 4 — экономия TCP-сокетов, для 2-3 устройств достаточно
#else
