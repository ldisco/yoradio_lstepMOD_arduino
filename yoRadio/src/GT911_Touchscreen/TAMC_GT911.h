...
class TAMC_GT911 {
  public:
    ...
    // Флаг доступности тач-контроллера на шине I2C.
    // Если устройство не ответило, чтение временно отключается,
    // чтобы не засыпать монитор бесконечными ошибками I2C.
    bool isOnline = true;
